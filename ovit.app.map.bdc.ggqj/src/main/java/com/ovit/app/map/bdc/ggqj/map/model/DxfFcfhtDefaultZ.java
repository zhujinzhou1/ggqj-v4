...
public class DxfFcfhtDefaultZ {
    ...
    public DxfFcfhtDefaultZ(MapInstance mapInstance) {
        this.mapInstance = mapInstance;
        set(mapInstance.aiMap.getProjectWkid());
    }

    public DxfFcfhtDefaultZ set(String dxfpath) {
        this.dxfpath = dxfpath;
        return this;
    }

    public DxfFcfhtDefaultZ set(SpatialReference spatialReference) {
        this.spatialReference = spatialReference;
        return this;
    }

    public DxfFcfhtDefaultZ set(Feature f_bdc, Feature f_zd, List<Feature> fs_zrz, List<Feature> fs_z_fsjg, List<Feature> fs_h, List<Feature> fs_h_fsjg) {
    ...
    public DxfFcfhtDefaultZ write() throws Exception {
        getExtend(); // 多大范围
        if (dxf == null) {
            dxf = new DxfAdapter();
            // 创建dxf
...
//            dxf.write(mapInstance, fs_all, null);
            ...
            Point p_chr = new Point(envelope.getCenter().getX() + w * 1 / 3, envelope.getYMin() - o_split * 0.3, envelope.getSpatialReference());
            ...
            Point p_shr = new Point(envelope.getCenter().getX() + w * 1 / 3, envelope.getYMin() - 3*o_split * 0.3, envelope.getSpatialReference());
    ...
    public DxfFcfhtDefaultZ save() throws Exception {
        if (dxf != null) {
            dxf.save();
        }
        return this;
