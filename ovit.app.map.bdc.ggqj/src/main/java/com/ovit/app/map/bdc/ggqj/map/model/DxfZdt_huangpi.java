...
public class DxfZdt_huangpi {
    ...
    public DxfZdt_huangpi(MapInstance mapInstance) {
        this.mapInstance = mapInstance;
        set(mapInstance.aiMap.getProjectWkid());
    }

    public DxfZdt_huangpi set(String dxfpath) {
        this.dxfpath = dxfpath;
        return this;
    }

    public DxfZdt_huangpi set(SpatialReference spatialReference) {
        this.spatialReference = spatialReference;
        return this;
    }

    public DxfZdt_huangpi set(Feature f_zd, List<Feature> fs_zd, List<Feature> fs_zrz, List<Feature> fs_z_fsjg, List<Feature> fs_h_fsjg
    ...
    public DxfZdt_huangpi write() throws Exception {
        getExtend(); // 多大范围
        if (dxf == null) {
            dxf = new DxfAdapter();
            // 创建dxf
...
//                dxf.write(cel_1_1,"不动产单元号");
            ...
            dxf.write(cel_1_2, null, Get(f_zd, FeatureHelper.TABLE_ATTR_ZDDM, ""), o_fontsize, null, false, o_fontcolor, 0);
            // 单元格1-3
            x_ = x_ + w * 2 / 5;
            ...
            dxf.write(cel_2_4, null, FeatureHelper.Get(f_zd,FeatureHelper.TABLE_ATTR_ZDMJ,0.00)+"", o_fontsize, null, false, o_fontcolor, 0);
...
//            DxfHelper.writeN(new Point(p_n.getX(), p_n.getY() - o_split, p_n.getSpatialReference()), o_split,dxf);
            ...
            Point p_drawDate =new Point(envelope.getXMin(),envelope.getYMin()-h);
            ...
            Point p_blc = new Point(envelope.getCenter().getX() , envelope.getYMin() -h, envelope.getSpatialReference());
            dxf.writeText(p_blc, "1:300", o_fontsize, DxfHelper.FONT_WIDTH_DEFULT, o_fontstyle, 0, 1, 2, o_fontcolor, null, null);
            ...
            Point p_shr = new Point(envelope.getXMax(),envelope.getYMin()-2*h);
    ...
    public DxfZdt_huangpi save() throws Exception {
        if (dxf != null) {
            dxf.save();
        }
        return this;
