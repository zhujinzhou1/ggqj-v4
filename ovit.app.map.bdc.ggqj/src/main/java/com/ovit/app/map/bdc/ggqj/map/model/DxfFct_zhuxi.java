...
public class DxfFct_zhuxi {
    ...
    public DxfFct_zhuxi(MapInstance mapInstance) {
        this.mapInstance = mapInstance;
        set(mapInstance.aiMap.getProjectWkid());
    }

    public DxfFct_zhuxi set(String dxfpath) {
        this.dxfpath = dxfpath;
        return this;
    }

    public DxfFct_zhuxi set(SpatialReference spatialReference) {
        this.spatialReference = spatialReference;
        return this;
    }

    public DxfFct_zhuxi set(String bdcdyh, Feature f_zd, List<Feature> fs_zrz, List<Feature> fs_z_fsjg, List<Feature> fs_h, List<Feature> fs_h_fsjg) {
        this.bdcdyh = bdcdyh;
        this.f_zd = f_zd;
...
///            o_fontsize = (float) (o_fontsize*scale);
    ...
    public DxfFct_zhuxi write() throws Exception {
        getExtend(); // 多大范围
        if (dxf == null) {
            dxf = new DxfAdapter();
            // 创建dxf
...
//          绘制日期
    ...
    public DxfFct_zhuxi save() throws Exception {
        if (dxf != null) {
            dxf.save();
        }
        return this;
