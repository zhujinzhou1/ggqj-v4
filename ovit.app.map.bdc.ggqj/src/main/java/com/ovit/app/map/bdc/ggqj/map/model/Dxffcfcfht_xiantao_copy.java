...
public class Dxffcfcfht_xiantao_copy {
    ...
    public Dxffcfcfht_xiantao_copy(MapInstance mapInstance) {
        this.mapInstance = mapInstance;
        set(MapHelper.getSpatialReference(mapInstance));
    }

    public Dxffcfcfht_xiantao_copy set(String dxfpath) {
        this.dxfpath = dxfpath;
        return this;
    }

    public Dxffcfcfht_xiantao_copy set(SpatialReference spatialReference) {
        this.spatialReference = spatialReference;
        return this;
    }

    public Dxffcfcfht_xiantao_copy set(String bdcdyh, Feature f_zd, List<Feature> fs_zrz, List<Feature> fs_z_fsjg, List<Feature> fs_h, List<Feature> fs_h_fsjg) {
        this.bdcdyh = bdcdyh;
        this.f_zd = f_zd;
        this.fs_zrz = fs_zrz;
    ...
    public Dxffcfcfht_xiantao_copy write() throws Exception {
        getExtend(); // 多大范围
...
//                String auditDate ="2019年3月15日";
    ...
    public Dxffcfcfht_xiantao_copy save() throws Exception {
        if (dxf != null) {
            dxf.save();
        }
        return this;
