...
//                writeN(new Point(p_n.getX(), p_n.getY() - o_split, p_n.getSpatialReference()), o_split, -alpha);
                ...
                dxf.write(cel_4_13, DxfHelper.LINETYPE_SOLID_LINE, "层建筑面积合计", o_fontsize, h_fontstyle, false, DxfHelper.COLOR_BYLAYER, 0);

                x_ = x + w / 2;
                y_ = y_ - h;
                Envelope cel_4_14 = new Envelope(x_, y_, x_ + w / 12, y - p_height, p_extend.getSpatialReference());
                dxf.write(cel_4_14, DxfHelper.LINETYPE_SOLID_LINE, "坐落", o_fontsize, h_fontstyle, false, DxfHelper.COLOR_BYLAYER, 0);

                x_ = x_ + w / 12;
                Envelope cel_4_14_2 = new Envelope(x_, y_, x + w, y - p_height, p_extend.getSpatialReference());
                dxf.write(cel_4_14_2, DxfHelper.LINETYPE_SOLID_LINE, FeatureHelper.Get(f_zd, "ZL", ""), o_fontsize, h_fontstyle, false, DxfHelper.COLOR_BYLAYER, 0);
