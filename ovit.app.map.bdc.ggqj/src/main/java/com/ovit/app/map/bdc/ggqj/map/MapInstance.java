...
import com.ovit.app.map.bdc.ggqj.map.view.bdc.FeatureEditFSSS;
...
//                    + AiUtil.GetValue(feature.getAttributes().get("JZWMC"), "")+" "
        ...
        }else if (tableName.equals(FeatureHelper.TABLE_NAME_FSSS)) {
            label = FeatureHelper.Get(feature,"QLR","") + "\n"
    ...
    public void registFeatureEditTypeMap(){
        ...
        FeatureEdit.TypeMap.put(FeatureHelper.TABLE_NAME_FSSS,FeatureEditFSSS.class);
    ...
    public void registFeatureViewTypeMap(){
        ...
        FeatureView.TypeMap.put(FeatureHelper.TABLE_NAME_FSSS,FeatureViewFSSS.class);
