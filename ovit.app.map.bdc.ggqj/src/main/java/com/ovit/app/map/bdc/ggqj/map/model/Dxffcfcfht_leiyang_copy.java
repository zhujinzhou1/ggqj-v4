...
public class Dxffcfcfht_leiyang_copy {
    ...
    public Dxffcfcfht_leiyang_copy(MapInstance mapInstance) {
        this.mapInstance = mapInstance;
        set(MapHelper.getSpatialReference(mapInstance));
    }

    public Dxffcfcfht_leiyang_copy set(String dxfpath) {
        this.dxfpath = dxfpath;
        return this;
    }

    public Dxffcfcfht_leiyang_copy set(SpatialReference spatialReference) {
        this.spatialReference = spatialReference;
        return this;
    }

    public Dxffcfcfht_leiyang_copy set(String bdcdyh, Feature f_zd, List<Feature> fs_zrz, List<Feature> fs_z_fsjg, List<Feature> fs_h, List<Feature> fs_h_fsjg) {
        this.bdcdyh = bdcdyh;
        this.f_zd = f_zd;
...
//        p_extend = new Envelope(x_min, y_min, x_max, y_max, o_extend.getSpatialReference());
    ...
    public Dxffcfcfht_leiyang_copy write() throws Exception {
        getExtend(); // 多大范围
...
//        }
    ...
    public Dxffcfcfht_leiyang_copy save() throws Exception {
        if (dxf != null) {
            dxf.save();
        }
        return this;
