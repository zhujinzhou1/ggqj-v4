...
//                writeN(new Point(p_n.getX(), p_n.getY() - o_split, p_n.getSpatialReference()), o_split, -alpha);
                ...
                Envelope cel_2_1 = new Envelope(x_, y_, x + w / 2, y - p_height, p_extend.getSpatialReference());
                writeC(cs,1, page, cel_2_1);

                //    二 层平面图
                Envelope cel_1_1 = new Envelope(x_ + w / 2, y_, x + w, y - p_height , p_extend.getSpatialReference());
